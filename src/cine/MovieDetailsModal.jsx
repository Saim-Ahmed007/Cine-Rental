      ...
      >
        ...
        >
          ...
          <div className="p-5 lg:p-11">
            <div className="">
              <h2 className="text-3xl text-[#323234] lg:text-[50px] mb-2 font-bold">{movie.title}</h2>
              <span
                className="block text-base  text-[#323234] dark:text-[#575A6E] my-3">{movie.genre}</span>
              <div></div>
            </div>
            <p className="text-sm  text-[#323234] lg:text-base mb-8 lg:mb-16">
              {movie.description}
            </p>
